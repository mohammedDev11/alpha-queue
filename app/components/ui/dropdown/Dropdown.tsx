...
//       onSelect,
//     }),
//     [open, selectedValue, selectedLabel]
//   );
...
//       className={`flex  items-center justify-between gap-3 rounded-md border px-4 py-2.5 transition ${className}`}
//       style={{
...
//           className={`absolute top-[calc(100%+10px)] z-50 rounded-md border p-2 shadow-xl ${widthClassName} ${
